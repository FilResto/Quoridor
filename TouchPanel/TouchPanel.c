...
void TouchPanel_Calibrate(void)
{
  ...
  for(i=0;i<3;i++)
  {     
   #ifndef SIMULATOR //sta compilando sempre come se fosse simulator, quindi quando uso la scheda aumento il delay a linea 488, se no delay a 10 ms
	 //DelayUS(1000 * 500);//parte con un ritardo di tantissimi millisecondi, usa questo sulla landtiger
	 DelayUS(10);//metti questo su simulatore, quello sopra sulla scheda
	 #else
